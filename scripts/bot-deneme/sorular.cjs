...
module.exports = {
  ...
  sorular: [
    ...
    { id: 'o-kdv-ay-adi', taraf: 'owner', soru: 'hasan rauf saydan a haziran 2026 döneminde ne kadar kdv çıktı',
      beklenen: [/17\.803,37/], olmamali: [/15\.804,37/, /11\.044,57/] },
    { id: 'o-kdv-ay-kod', taraf: 'owner', soru: 'hasan rauf saydan 2026-05 kdv ne kadar',
      beklenen: [/15\.804,37/], olmamali: [/17\.803,37/, /11\.044,57/] },
