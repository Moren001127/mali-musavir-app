  ...
  if (!duzenle) {
    return (
      <button
        ...
        style={portalStyle({ color: user.phone ? 'rgba(250,250,249,0.85)' : 'rgba(250,250,249,0.4)' })}
      >
        <MessageSquare size={12} style={portalStyle({ color: user.phone ? '#22c55e' : 'rgba(250,250,249,0.3)' })} />
