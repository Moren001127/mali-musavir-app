      ...
      >
        ...
        <div className="mt-2 flex items-center justify-between gap-3 flex-wrap">
          ...
          >
            ...
            >
              <ShieldCheck size={22} style={portalStyle({ color: '#1a1205' })} />
            </span>
            Denetim Günlüğü
          </h1>
        </div>
        ...
        <div className="flex flex-wrap gap-3 items-end">
          ...
          <div>
            ...
            >
              ...
              {(facets?.users || []).map((u) => (
                <option key={u.id} value={u.id} style={portalStyle({ background: '#0f0d0b' })}>
          ...
          <div>
            ...
            >
              ...
              {(facets?.resources || []).map((r) => (
                <option key={r.value} value={r.value} style={portalStyle({ background: '#0f0d0b' })}>
          ...
          <div>
            ...
            >
              ...
              {(facets?.actions || []).map((a) => (
                <option key={a.value} value={a.value} style={portalStyle({ background: '#0f0d0b' })}>
