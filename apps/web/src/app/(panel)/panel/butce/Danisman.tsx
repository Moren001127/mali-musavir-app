...
export default function Danisman() {
  ...
  return (
    <div
      ...
      style={portalStyle({ height: 'calc(100vh - 260px)', minHeight: 420 })}
    >
      {/* ===== Sohbet ===== */}
      <section
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-[13.5px] font-semibold" style={portalStyle({ color: TEXT })}>
                Finans danışmanı
              </h3>
              <p className="text-[11px]" style={portalStyle({ color: MUTED })}>
        ...
        <div ref={akisRef} className="min-h-0 flex-1 space-y-4 overflow-y-auto px-5 py-5">
          {bos ? (
            <div className="flex h-full min-h-[360px] flex-col items-center justify-center px-6 text-center">
              ...
              <h4 className="text-[14px] font-semibold" style={portalStyle({ color: TEXT })}>
                Paranızla ilgili ne merak ediyorsunuz?
              </h4>
              <p className="mt-1.5 max-w-md text-[12px] leading-relaxed" style={portalStyle({ color: MUTED })}>
            ...
            mesajlar.map((m) =>
              m.rol === 'soru' ? (
                <div key={m.id} className="flex justify-end gap-2.5">
                  ...
                  >
                    {m.metin}
                    <div className="mt-1 text-right text-[10px]" style={portalStyle({ color: MUTED })}>
          ...
          {sor.isPending && (
            <div className="flex gap-2.5">
              ...
              >
                <Loader2 size={13} className="animate-spin" style={portalStyle({ color: MOR })} />
      ...
      <aside className="min-h-0 space-y-3 overflow-y-auto pr-1">
        ...
        >
          <h4 className="flex items-center gap-1.5 text-[12px] font-semibold" style={portalStyle({ color: TEXT })}>
            <Lightbulb size={13} style={portalStyle({ color: GOLD })} /> Hazır sorular
          </h4>
          <p className="mt-0.5 text-[10.5px]" style={portalStyle({ color: MUTED })}>
        ...
        >
          <ShieldCheck size={13} style={portalStyle({ color: OK })} className="mt-0.5 flex-shrink-0" />
          <span>
