...
export default function SgkAutomationPage() {
  return (
    <div data-ops-page="ajanlar" className="space-y-5 max-w-7xl">
      ...
      <div data-ops-header="true" className="rounded-2xl border overflow-hidden relative" style={portalStyle({ background: 'rgba(255,255,255,0.02)', borderColor: 'rgba(255,255,255,0.07)' })}>
        <div className="absolute top-0 left-0 right-0 h-[3px]" style={portalStyle({ background: 'linear-gradient(90deg, #d4b876, transparent)' })} />
        <div className="p-6 flex items-start gap-4">
          <span className="grid place-items-center rounded-2xl flex-shrink-0" style={portalStyle({ width: 56, height: 56, background: 'radial-gradient(circle at 30% 30%, rgba(212,184,118,0.22), rgba(212,184,118,0.06))', border: '1px solid rgba(212,184,118,0.25)', color: '#d4b876' })}>
            <ShieldCheck size={26} />
          </span>
