...
export const SABLONLAR: Sablon[] = [
  ...
  { id: 'vadesi-gecmis', ad: 'Vadesi geçmiş', ajanId: 'koordinator', mukellefIster: false, donemIster: false, gorev: 'Vadesi geçmiş tahsilatları mükellef bazında listele; {mükellef} seçiliyse ekstre özetini çıkar.' , grup: 'Diğer' },
