...
const SISTEM_DENETIM_KRITERLERI = [
  ...
  },
  {
    ...
    hesap: '591',
    kosul: 'Bakiye > 0',
    aciklama: '591 Dönem Net Zararı bakiyesinin geçmiş yıl zararlarına (580) devredilip devredilmediğini kontrol eder (590→570 kuralının zarar eşi).',
  },
  {
    tip: 'ORTULU_SERMAYE_RISKI',
    seviye: 'WARN',
    hesap: '331 / 431 ↔ özsermaye',
    kosul: 'Ortaklara borçlar > özsermaye × 3',
    aciklama: 'KVK 12: ortaklara/ilişkili kişilere borçlar (331+431) özsermayenin 3 katını aşarsa aşan kısma isabet eden faiz/kur/vade farkı KKEG sayılır — örtülü sermaye riski.',
  },
  {
    tip: 'TTK376_TEKNIK_IFLAS',
    seviye: 'ERROR',
    hesap: '500 / özsermaye',
    kosul: 'Yıl sonu özsermaye < 0',
    aciklama: 'TTK 376: özsermaye negatifse borca batıklık (teknik iflas) — yönetim genel kurulu toplayıp tedbir almakla yükümlü.',
  },
  {
    tip: 'TTK376_SERMAYE_KAYBI',
    seviye: 'WARN',
    hesap: '500 / özsermaye',
    kosul: 'Yıl sonu özsermaye < sermaye / 2',
    aciklama: 'TTK 376: özsermaye, ödenmiş sermayenin yarısının altına düşmüşse sermaye kaybı — genel kurulu bilgilendirme ve iyileştirme tedbirleri gerekir.',
  },
  {
    tip: 'ORTAK_CARI_CIFT_YONLU',
    seviye: 'INFO',
    hesap: '131 + 331',
    kosul: 'Hem 131 hem 331 bakiye veriyor',
    aciklama: 'Aynı dönemde hem ortaklardan alacak (131) hem ortaklara borç (331) bakiyesi varsa örtülü kazanç dağıtımı / transfer fiyatlandırması ve adat faizi yönünden kontrol önerir.',
  },
  {
