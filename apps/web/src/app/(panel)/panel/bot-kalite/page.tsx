      ...
      >
        ...
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            ...
            style={portalStyle({ background: `linear-gradient(135deg, ${TEAL}, #0d9488)`, color: '#0f0d0b', boxShadow: '0 8px 20px rgba(20,184,166,0.22)' })}
          >
                  ...
                  <article key={kayit.id} className="grid gap-4 p-4 xl:grid-cols-[1fr_240px]" style={portalStyle({ borderColor: 'rgba(255,255,255,0.06)' })}>
                    ...
                    <div className="flex flex-col gap-2">
                      <select
                        ...
                        style={portalStyle({ background: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', color: '#fafaf9' })}
                      >
