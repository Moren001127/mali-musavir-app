...
export function MorenAiOzetWidget() {
  ...
  return (
    <section
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(139,106,42,0.06), rgba(15,11,21,0.85))',
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4 gap-4">
        <div className="min-w-0">
          ...
          <p className="text-[12px] mt-1" style={{ color: 'rgba(31,24,18,0.52)' }}>
        ...
        {metrics.map((metric) => {
          ...
          return (
            <Link
              ...
              style={{ background: 'rgba(31,24,18,0.04)', border: `1px solid ${metric.color}22` }}
            >
              <div className="flex items-center gap-1.5 mb-1.5">
                <Icon size={12} style={{ color: metric.color }} />
                <span className="text-[9.5px] uppercase font-bold tracking-[.14em]" style={{ color: 'rgba(31,24,18,0.55)' }}>
                  {metric.label}
                </span>
              </div>
              <p
                ...
                style={{
                  ...
                  fontSize: 22,
                  fontWeight: 700,
                  color: isLoading ? 'rgba(31,24,18,0.36)' : '#1f1812',
                  letterSpacing: 0,
                  lineHeight: 1,
                }}
              >
              ...
              <p className="text-[10px] mt-1" style={{ color: 'rgba(31,24,18,0.45)' }}>
                {metric.sub}
              </p>
            </Link>
          );
      ...
      {bugunHata > 0 && (
        ...
        >
          ...
          <span className="text-[12px] font-semibold" style={{ color: '#1f1812' }}>
