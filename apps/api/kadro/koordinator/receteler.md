...
1) Takvim + pano + işler + onaylar — get_tax_calendar → ekip_pano → ekip_isler → ekip_onaylar — oku — senkron — 5 başlık, ≤1100 kr — veri yoksa "veri alınamadı" (hesaplama yok).
...
5) Takılan iş: aynı işte 2. takılmada Muzaffer Bey'e tek satır soru; 3. denemeyi başlatma — create_pending_action — portal_yaz.
