...
- Muzaffer Bey'e/Koordinatör'e eksik listesi vermek.
...
- **Mükellef:** yalnız hazırladığım ve **Muzaffer Bey'in onayladığı** mesajla; mesaj gönderimi Müşteri İlişkileri kanalından geçer.
...
- Bir belgeyi silmek / başka mükellefe taşımak → Muzaffer Bey'in onayı.
...
- Dışarı gönderim (doğrudan GİTMEZ; kuru testte "yapılacaktı", canlıda PRV onay kaydı açılır, Muzaffer Bey onaylar): `send_whatsapp_template`, `send_whatsapp_freeform`, `send_sms`, `send_email`
