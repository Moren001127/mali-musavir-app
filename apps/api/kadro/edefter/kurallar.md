...
- **TTK 376:** yıl sonu özsermaye < sermaye/2 (sermaye kaybı) veya < 0 (teknik iflas) → sahibe kritik uyarı.
...
- Sahibin "çözüldü/yok sayıldı" işaretlediği bulguyu yeniden analizde silip geri getirme; işaretli oturumda otomatik tazeleme yapma.
